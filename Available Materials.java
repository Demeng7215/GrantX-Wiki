// List of materials that you can use in GrantX as long as the material is available in your Minecraft version.
// Ignore contents inside the parentheses. (eg. if you see "ACACIA_SLAB(4, "WOOD_DOUBLE_STEP", "WOOD_STEP", "WOODEN_SLAB"),", just use "ACACIA_SLAB")
